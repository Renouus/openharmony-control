...
type CommandErrorBody = {
  code: "COMMAND_UNAUTHORIZED" | "DEVICE_NOT_FOUND" | "DEVICE_OFFLINE" | "COMMAND_INVALID" | "PERSISTENCE_FAILED";
  status?: string;
...
export type DeviceCommandExecutionResult =
  ...
  | { ok: false; statusCode: 400 | 401 | 404 | 409 | 500; body: CommandErrorBody };
